...
# its own VPC (10.4.0.0/16), its own IAM roles (inference-phase4-5-*), its own
# Karpenter discovery tags.
#
# COST: ~$0.23/hr idle ($0.10 EKS + $0.08 CPU + $0.045 NAT)
#        ~$0.55/hr with GPU ($0.16-0.50 Spot g4dn.xlarge)
#
# Usage: bash phase4.5/scripts/setup-cluster.sh
...
# context was active before. This switches to inference-phase4-5.
# ──────────────────────────────────────────────────────────────────────────────
...
echo "- Build AMI (optional): bash phase4.5/scripts/build-ami-soci.sh"
echo ""
