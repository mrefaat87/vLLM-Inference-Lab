...
#
# USAGE:
#   bash phase4/scripts/rollback.sh         # interactive (asks for confirmation)
#   bash phase4/scripts/rollback.sh --yes   # skip confirmation (for CI/automation)
...
echo "    bash phase4/scripts/deploy.sh [policy-a|policy-b|policy-c|policy-d]"
echo ""
