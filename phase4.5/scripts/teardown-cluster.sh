...
#
# Usage: bash phase4.5/scripts/teardown-cluster.sh
...
CLUSTER_NAME=$(terraform -chdir="$TF_DIR" output -raw cluster_name 2>/dev/null || echo "inference-phase4-5")
...
echo ""
echo "  To recreate:"
echo "    cd phase4.5/terraform && terraform apply"
