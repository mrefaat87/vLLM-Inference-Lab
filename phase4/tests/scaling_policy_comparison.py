...
GRAFANA SNAPSHOTS:
  ...
  Stored in phase4/tests/snapshots/policy-{a,b,c,d}_phase-{1..7}.png
...
Usage:
    ...
    # Run all 4 policies
    python3 phase4/tests/scaling_policy_comparison.py --host http://localhost:8080
