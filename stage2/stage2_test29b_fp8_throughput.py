"""
Test 29B: FP8 KV Cache — Throughput Scaling
...
Usage: python3 stage2_test29b_fp8_throughput.py --host http://<ip>:8000
"""
...
def main():
    global HOST
    parser = argparse.ArgumentParser(description="Test 29B: FP8 KV Cache — Throughput Scaling")
    parser.add_argument("--host", required=True)
    args = parser.parse_args()
    HOST = args.host.rstrip("/")

    print(f"Test 29B: FP8 KV Cache — Throughput Scaling")
    print(f"Target: {HOST} | Model: {MODEL}")
    print(f"KV Cache: fp8_e5m2 (compare against Test 5 fp16 baseline)")
    ...
    # Save results
    output_file = "stage2_test29b_results.json"
