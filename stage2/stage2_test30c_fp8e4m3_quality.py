#!/usr/bin/env python3
"""
Test 30C: FP8 KV Cache — Accuracy Preservation
...
Usage: python3 stage2_test30c_fp8_quality.py --host http://<ip>:8000
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Test 30C: FP8 KV Cache — Accuracy Preservation",
    )
    ...
    print(f"KV Cache: fp8_e4m3 (A10G Ampere) (compare against Test 29C T4 fp8_e5m2 + Test 7 fp16 baseline)")
    ...
    json_results = {
        ...
        "model": args.model,
        "kv_cache_dtype": "fp8_e4m3 (A10G Ampere)",
    ...
    output_file = "stage2_test30c_results.json"
