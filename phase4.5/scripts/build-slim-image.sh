...
#
# USAGE:
#   bash phase4.5/scripts/build-slim-image.sh
#
set -euo pipefail
...
echo ""
echo "  NEXT STEPS:"
echo "    1. Create SOCI index: bash phase4.5/scripts/setup-soci.sh"
echo "    2. Rebuild prebaked AMI: bash phase4.5/scripts/build-ami.sh"
echo "    3. Rebuild SOCI AMI: bash phase4.5/scripts/build-ami-soci.sh"
echo "    4. Run benchmark: python3 phase4.5/tests/cold_start_benchmark.py --host http://localhost:8080"
