...
#
# USAGE:
#   bash phase4.5/scripts/upload-model-to-s3.sh                                     # defaults
#   bash phase4.5/scripts/upload-model-to-s3.sh my-custom-bucket                    # custom bucket
#   MODEL_NAME="meta-llama/Llama-3-8B" bash phase4.5/scripts/upload-model-to-s3.sh  # custom model
#
...
echo "    grep MODEL_CACHE_BUCKET phase4.5/k8s/worker/deployment-patch.yaml"
echo ""
