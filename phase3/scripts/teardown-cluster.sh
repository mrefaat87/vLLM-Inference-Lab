...
CLUSTER_NAME=$(terraform -chdir="$TF_DIR" output -raw cluster_name 2>/dev/null || echo "inference-phase3")

echo "============================================"
echo "  Phase 3 — Teardown Cluster"
echo "============================================"
echo ""
echo "  Cluster: ${CLUSTER_NAME}"
echo "  This will DESTROY the entire Phase 3 EKS cluster."
...
# Step 1: Delete K8s namespace (cascades to all resources)
echo "=== Deleting K8s namespace ==="
...
echo ""
echo "============================================"
echo "  Phase 3 Cluster Destroyed"
echo "============================================"
echo ""
echo "  Preserved:"
echo "    - ECR repos (inference-lab/api-gateway, inference-lab/worker)"
echo "    - S3 model cache bucket"
echo "    - Phase 1/4 cluster (inference-lab) — untouched"
echo ""
echo "  To switch back to the main cluster:"
echo "    aws eks update-kubeconfig --name inference-lab --region us-east-1"
