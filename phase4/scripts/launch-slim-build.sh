...
#
# USAGE:
#   bash phase4/scripts/launch-slim-build.sh
#
set -euo pipefail
...
LAUNCH_SPEC=$(cat << EOF
{
    ...
    "IamInstanceProfile": {"Name": "inference-phase4-karpenter-node"},
...
echo "    bash phase4/scripts/setup-soci.sh   # Create SOCI index for slim image"
echo "    bash phase4/scripts/build-ami.sh     # Rebuild prebaked AMI"
echo "    bash phase4/scripts/build-ami-soci.sh # Rebuild SOCI AMI"
